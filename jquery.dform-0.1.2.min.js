...
(function(a){function h(c,e,b){return function(d){d=a.dform.htmlAttributes(d,b);return a(c).attr(a.extend(d,e))}}a.dform.addType({text:h("<input>",{type:"text"}),password:h("<input>",{type:"password"}),submit:h("<input>",{type:"submit"}),reset:h("<input>",{type:"reset"}),hidden:h("<input>",{type:"hidden"}),radio:h("<input>",{type:"radio"}),checkbox:h("<input>",{type:"checkbox"}),checkboxes:h("<div>",{},["name"]),radiobuttons:h("<div>",{},["name"]),container:h("<div>",{}),file:h("<input>",{type:"file"})});
