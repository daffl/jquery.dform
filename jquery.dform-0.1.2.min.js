...
"html",function(c){c=c.split(".");if(c.length>1){var e=c.shift();if(e=jQuery.global.localize(e))(c=a.getValueAt(e,c))&&a(this).html(c)}});a.dform.subscribeIf(a.global,"options",function(c,e){e=="select"&&typeof c=="string"&&a(this).html("")});a.dform.subscribeIf(a.isFunction(a.fn.wysiwyg),"wysiwyg",function(){})})(jQuery);
