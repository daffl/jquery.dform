...
a.dform.createElement(b);a(this).append(a(d));a(d).runAll(b);return a(this)},buildForm:function(b){if(typeof b=="string"){var d=this;a.get(b,data,function(f){a(d).buildForm(f)},"json")}else if(a(this).is("form")){b=a.extend({type:"form"},b);a(this).dformAttr(b);a(this).runAll(b)}else a(this).formElement(b)},dformAttr:function(b,d){var f=a.keyset(c);a.isArray(d)&&a.merge(f,d);this.attr(a.withoutKeys(b,f));return this}});a.extend(a,{keyset:function(b){var d=[];a.each(b,function(f){d.push(f)});return d},
withKeys:function(b,d){var f={};a.each(d,function(g,i){if(b[i])f[i]=b[i]});return f},withoutKeys:function(b,d){var f={};a.each(b,function(g,i){if(a.inArray(g,d)==-1)f[g]=i});return f}});a.dform={options:{prefix:"ui-dform-",defaultType:function(b){return a("<"+b.type+">").dformAttr(b)}},removeType:function(b){delete e[b]},typeNames:function(){return a.keyset(e)},addType:function(b,d){h(e,b,d)},addTypeIf:function(b,d,f){b&&a.dform.addType(d,f)},subscriberNames:function(){return a.keyset(c)},subscribe:function(b,
d){h(c,b,d)},subscribeIf:function(b,d,f){b&&a.dform.subscribe(d,f)},removeSubscription:function(b){delete c[b]},hasSubscription:function(b){return c[b]?true:false},createElement:function(b){var d=b.type;if(!d)throw"No element type given! Must always exist.";var f=null;if(e[d]){var g=a.withoutKeys(b,"type");a.each(e[d],function(i,j){f=j.call(f,g)})}else f=a.dform.options.defaultType(b);return a(f)}}})(jQuery);
