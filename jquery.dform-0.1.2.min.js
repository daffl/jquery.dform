...
a.dform.createElement(b);a(this).append(a(d));a(d).runAll(b);return a(this)},buildForm:function(b){if(a(this).is("form")){b=a.extend({type:"form"},b);a(this).attr(a.dform.htmlAttributes(b));a(this).runAll(b)}else a(this).formElement(b)}});a.extend(a,{keyset:function(b){var d=[];a.each(b,function(f){d.push(f)});return d},withKeys:function(b,d){var f={};a.each(d,function(g,i){if(b[i])f[i]=b[i]});return f},withoutKeys:function(b,d){var f={};a.each(b,function(g,i){if(a.inArray(g,d)==-1)f[g]=i});return f}});
a.dform={options:{prefix:"ui-dform-",defaultType:function(b){var d=a.dform.htmlAttributes(b);return a("<"+b.type+">").attr(d)}},htmlAttributes:function(b,d){var f=a.keyset(c);a.isArray(d)&&a.merge(f,d);return a.withoutKeys(b,f)},removeType:function(b){delete e[b]},typeNames:function(){return a.keyset(e)},addType:function(b,d){h(e,b,d)},addTypeIf:function(b,d,f){b&&a.dform.addType(d,f)},subscriberNames:function(){return a.keyset(c)},subscribe:function(b,d){h(c,b,d)},subscribeIf:function(b,d,f){b&&
