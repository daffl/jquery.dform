...
(function(a){a.fn.placeholder=function(h){var c=this;this.data("placeholder",h);this.val(h);this.focus(function(){this.val()==this.data("placeholder")&&this.val("")});this.blur(function(){this.val()==""&&this.val(this.data("placeholder"))});this.parents("form").submit(function(){a(c).val()==a(c).data("placeholder")&&a(c).val("")})}})(jQuery);
