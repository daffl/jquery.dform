...
{keyset:function(b){return a.map(b,function(e,g){return g})},withKeys:function(b,e){var g={};d(e,function(m,k){if(b[k])g[k]=b[k]});return g},withoutKeys:function(b,e){var g={};d(b,function(m,k){~a.inArray(m,e)||(g[m]=k)});return g},dform:{options:{prefix:"ui-dform-"},defaultType:function(b){return a("<"+b.type+">").dform("attr",b)},types:function(b){return b?h[b]:h},addType:c(h),subscribers:function(b){return b?l[b]:l},subscribe:c(l),hasSubscription:function(b){return l[b]?true:false},createElement:function(b){if(!b.type)throw"No element type given! Must always exist.";
