(function(a){var m={},h={},d=a.each,c=function(b){var e=function(g,k,l){if(typeof g==="object")a.each(g,function(n,o){e(n,o,l)});else if(l===undefined||l===true){b[g]||(b[g]=[]);b[g].push(k)}};return e},f=a.isArray,i=function(b,e,g){a.dform.hasSubscription(b)&&this.each(function(){var k=a(this);d(m[b],function(l,n){n.call(k,e,g)})});return this},j=function(b){var e=b.type,g=this;this.dform("run","[pre]",b,e);d(b,function(k,l){g.dform("run",k,l,e)});this.dform("run","[post]",b,e);return this};a.extend(a,
...
var e=b.type,g=null,k=a.withoutKeys(b,["type"]);if(h[e])d(h[e],function(l,n){g=n.call(g,k)});else g=a.dform.defaultType(b);return a(g)},methods:{run:function(b,e,g){if(typeof b!=="string")return j.call(this,b);return i.call(this,b,e,g)},append:function(b,e){if(e&&a.dform.converters&&a.isFunction(a.dform.converters[e]))b=a.dform.converters[e](b);e=a.dform.createElement(b);this.append(e);e.dform("run",b)},attr:function(b,e){var g=a.keyset(m);f(e)&&a.merge(g,e);this.attr(a.withoutKeys(b,g))},ajax:function(b,
e,g){g={error:g,url:b};var k=this;typeof b!=="string"&&a.extend(g,b);g.success=function(l){k.dform(l);e&&e(l,k)};a.ajax(g)},init:function(b,e){b=b.type?b:a.extend({type:"form"},b);if(e&&a.dform.converters&&a.isFunction(a.dform.converters[e]))b=a.dform.converters[e](b);if(this.is(b.type)){this.dform("attr",b);this.dform("run",b)}else this.dform("append",b)}}}});a.fn.dform=function(b,e,g){var k=a(this);if(a.dform.methods[b])a.dform.methods[b].apply(k,Array.prototype.slice.call(arguments,1));else typeof b===
"string"?a.dform.methods.ajax.call(k,{url:b,dataType:"json"},e,g):a.dform.methods.init.apply(k,arguments);return this}})(jQuery);
(function(a){var m=a.each,h=function(c,f){return function(i){return a(c).dform("attr",i,f)}},d=function(c){var f=this;if(a.isPlainObject(c))f.dform("append",c);else a.isArray(c)?m(c,function(i,j){f.dform("append",j)}):f.html(c)};a.dform.addType({container:h("<div>"),text:h('<input type="text" />'),password:h('<input type="password" />'),submit:h('<input type="submit" />'),reset:h('<input type="reset" />'),hidden:h('<input type="hidden" />'),radio:h('<input type="radio" />'),checkbox:h('<input type="checkbox" />'),
file:h('<input type="file" />'),number:h('<input type="number" />'),url:h('<input type="url" />'),tel:h('<input type="tel" />'),email:h('<input type="email" />'),checkboxes:h("<div>",["name"]),radiobuttons:h("<div>",["name"])});a.dform.subscribe({"class":function(c){this.addClass(c)},html:d,elements:d,value:function(c){this.val(c)},css:function(c){this.css(c)},options:function(c,f){var i=this;if(f==="select"||f==="optgroup")m(c,function(j,b){j={type:"option",value:j};if(typeof b==="string")j.html=
b;if(typeof b==="object")j=a.extend(j,b);i.dform("append",j)});else if(f==="checkboxes"||f==="radiobuttons")m(c,function(j,b){var e=f==="radiobuttons"?{type:"radio"}:{type:"checkbox"};if(typeof b==="string")e.caption=b;else a.extend(e,b);e.value=j;i.dform("append",e)})},caption:function(c,f){var i={};if(typeof c==="string")i.html=c;else a.extend(i,c);if(f=="fieldset"){i.type="legend";this.dform("append",i)}else{i.type="label";if(this.attr("id"))i["for"]=this.attr("id");c=a(a.dform.createElement(i));
...
(function(a){function m(d){if(a.isFunction(d.split)){d=d.split(".");if(d.length>1){var c=d.shift();if(c=jQuery.global.localize(c))return a.getValueAt(c,d)}}return false}var h=function(d,c){return a.withKeys(c,a.keyset(a.ui[d].prototype.options))};a.dform.addType("progressbar",function(d){return a("<div>").dform("attr",d).progressbar(h("progressbar",d))},a.isFunction(a.fn.progressbar));a.dform.addType("slider",function(d){return a("<div>").dform("attr",d).slider(h("slider",d))},a.isFunction(a.fn.slider));
a.dform.addType("accordion",function(d){return a("<div>").dform("attr",d)},a.isFunction(a.fn.accordion));a.dform.addType("tabs",function(d){return a("<div>").dform("attr",d)},a.isFunction(a.fn.tabs));a.dform.subscribe("entries",function(d,c){if(c=="accordion"){var f=this;a.each(d,function(i,j){i=a.extend({type:"div"},j);a(f).dform("append",i);if(j.caption){j=a(f).children("div:last").prev();j.replaceWith('<h3><a href="#">'+j.html()+"</a></h3>")}})}},a.isFunction(a.fn.accordion));a.dform.subscribe("entries",
...
a.isFunction(a.fn.ajaxForm));a.dform.subscribe(("html",function(d){if(typeof d==="string")(d=m(d))&&a(this).html(d)},a.global&&a.isFunction(a.global.localize)));if(a.global)a.getValueAt=function(d,c){c=isArray(c)?c:c.split(".");d=d;for(var f=0;f<c.length;f++){var i=c[f];if(!d[i])return false;d=d[i]}return d};a.dform.subscribe("options",function(d,c){if(c==="select"&&typeof d==="string"){a(this).html("");(d=m(d))&&a(this).dform("run","options",d,c)}},a.global)})(jQuery);
