...
"string")g.caption=f;else a.extend(g,f);g.value=d;a(b).formElement(g)})}},caption:function(c,e){var b={};if(typeof c=="string")b.html=c;else a.extend(b,c);if(e=="fieldset"){b.type="legend";var d=a.dform.createElement(b);this.prepend(d);a(d).runAll(b)}else{b.type="label";if(this.attr("id"))b["for"]=this.attr("id");d=a.dform.createElement(b);e=="checkbox"||e=="radio"?this.parent().append(a(d)):a(d).insertBefore(a(this));a(d).runAll(b)}},type:function(c,e){a.dform.options.prefix&&this.addClass(a.dform.options.prefix+
e)},"[post]":function(c,e){if(e=="checkboxes"||e=="radiobuttons")this.children("[type="+(e=="checkboxes"?"checkbox":"radio")+"]").each(function(){a(this).attr("name",c.name)})}})})(jQuery);
