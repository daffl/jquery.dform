...
c){b=a.dform.converters.dform(b);if(c&&a.dform.converters[c])b=a.dform.converters[c];var e=a.dform.createElement(b);this.append(a(e));a(e).runAll(b);return this},buildForm:function(b,c,e){if(typeof b=="string"){var g=a(this);a.get(b,c,function(i,j,k){a(g).buildForm(i);a.isFunction(e)&&e(i,j,k)},a.dform.options.ajaxFormat)}else{b.type||(b=a.extend({type:"form"},b));this.formElement(b,c)}return this},dformAttr:function(b,c){var e=a.keyset(f);a.isArray(c)&&a.merge(e,c);this.attr(a.withoutKeys(b,e));
